            ...
            <div class="text-center">
                ...
                <div class="position-relative">
                    <button type="button" class="btn btn-primary position-relative" style="font-size: 12px; margin-top: 5px;">Choose files
                        <input @change="onBrowseFile" accept=".png, .jpg, .jpeg"  type="file" style="position: absolute; left: 0; top: 0; opacity: 0; cursor: pointer;">
                    </button>
                </div>
            </div>
        </div>
        <div v-else v-bind:style="{backgroundImage: backgroundImg}" style="background-position: center; 
        height: 205px;
    ...
    export default {
        ...
        data() {
            return {
                ...
                isProgressing: false,
                backgroundImg:'',
                containerStyle:{backgroundRepeat: 'norepeat'}
            }
        },
        mounted() {
            let app = this;
            ...
            if(app.fieldKey !=null && app.fieldKey != ''){
                app.backgroundImg = 'url(' + this.fieldKey + ')';
            }
            ...
            app.dragAndDrop((e) => {
                ...
                app.$parent.$emit(app.fieldKey + "-uploaded", fileData)
            });
        },
        methods: {
            ...
            removeFile() {
                ...
                app.hasFile = false;
                app.file = null;
                app.$parent.$emit(app.fieldKey + "-removed")
            },
            ...
            onBrowseFile(e) {
                ...
                app.hasFile = true;
                app.file = fileData.file;
                app.imgSrc = URL.createObjectURL(app.file);
                app.backgroundImg = 'url('+app.imgSrc+')';
