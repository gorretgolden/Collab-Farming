...
<div class="bg-light w-85 pt-2 h-100  mt-2 ">
            ...
            <table class="table">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th scope="col">QUOTED DELIVERY</th>
                ...
                <tbody>
                    <tr>
                        <th scope="row" class="text-primary font-weight-normal">
                            <router-link to="/request-center">Tumusiime Edward</router-link>
                        </th>
                            <td>40 Bags of Chicken Feed</td>
    ...
    <!-- modal to complete delivery and confirm requests  -->
</div>
