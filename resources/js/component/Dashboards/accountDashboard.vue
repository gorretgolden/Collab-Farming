                ...
                >
                    ...
                    >
                        <li class="nav-item active">
                            <a
                                class="nav-link username-link text-muted mt-1"
                                href="#"
                                >Welcome {{ user.name }}</a
                            >
                        </li>
...
import MenuList from "../Layout/accountLayout/menuList.vue";
import SideNavigation from "../Layout/accountLayout/sideNavigation.vue";
import Request from "../mixins/requestHelper";
import AccountDashboardContent from "./accountDashboardContent.vue";
...
export default {
    ...
    components: { MenuList, SideNavigation, AccountDashboardContent },
