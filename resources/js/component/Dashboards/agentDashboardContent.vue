<template>
  <div class="w-100 ">
    ...
    <div class="row">
      <router-link to="/delivery-weights" class="d-contents">

      <div class="col-md-4">
        <div class="row">
          <div class="col-md-12 mb-2">
            <div class="w-100 cp-card cp-dashboard-menu p-4">
              <h5>Approved Egg Delivery Requests</h5>
      ...
      <div class="col-md-4">
        <div class="w-100 cp-card cp-dashboard-menu p-4">
          <h5>Approved Feed Requests for Delivery</h5>
          <div class="cp-menu-values">
            <div class="row">
              <div class="col-md-7">
                <h2>{{eggRequests.length}}</h2>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="cp-card cp-dashboard-menu p-4" style="height: 38em">
              <div class="row">
                <div class="col-14">
                  <h5 class="d-inline">Your Bulking Centers</h5>
