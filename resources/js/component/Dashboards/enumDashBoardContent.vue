<template>
  <div class="w-100">
    ...
    <div   style="margin-left:auto">
      <div class="btn-group">
        <router-link to="/farmer-profiling">
        <button
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="w-100 cp-card cp-dashboard-menu p-4">
          <h5>Egg Producers(Female)</h5>
          <div class="cp-menu-values">
            <div class="row">
              <div class="col-md-7">
                <h2>{{content.female}}</h2>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="cp-card cp-dashboard-menu p-4" style="height: 38em">
              <div class="row">
                <div class="col-14">
                  <h5 class="d-inline">Egg Producer Region</h5>
                  <h6
